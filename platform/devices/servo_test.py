...
# Platform 层：Pan / Tilt 均 invert=True → physical = min + max - logical
# Pan 逻辑 110° ↔ 物理 70°；Tilt 逻辑 5° ↔ 物理 85°（水平正视）
PAN_CENTER  = 70.0  # 物理正前方（Platform API pan=110）
TILT_CENTER = 85.0  # 物理水平正视（Platform API tilt=5）
TILT_MIN    = 2.0   # 物理安全下限
